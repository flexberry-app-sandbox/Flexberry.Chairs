...
CREATE TABLE [ChairLeg] (
	 ...
	 [Chair_m0] UNIQUEIDENTIFIER  NOT NULL,
...
CREATE TABLE [Chair] (
	 ...
	 [ChairType_m0] UNIQUEIDENTIFIER  NULL,
...
CREATE TABLE [ApplicationLog] (
 ...
 ALTER TABLE [ChairLeg] ADD CONSTRAINT [ChairLeg_FChair_0] FOREIGN KEY ([Chair_m0]) REFERENCES [Chair]
CREATE INDEX ChairLeg_IChair_m0 on [ChairLeg] ([Chair_m0])

 ALTER TABLE [Chair] ADD CONSTRAINT [Chair_FChairType_0] FOREIGN KEY ([ChairType_m0]) REFERENCES [ChairType]
CREATE INDEX Chair_IChairType_m0 on [Chair] ([ChairType_m0])
